...
app.controller('FormsModalsController', function ($scope, ServicioHTTP, authFact) {
    ...
    $scope.generaModalRechazo = function (pAccion) {
        ...
        if (pAccion === 'pendiente') {
            ...
            $scope.scpMensajeModalRechazo = 'Cancelar una solicitud ya revisada por la comisión PUEDE AFECTARLE EN LA ACEPTACIÓN DE FUTURAS SOLICITUDES. Indique razones válidas para la cancelación.';
    ...
    $scope.generarAlertaConf = function (pAccion) {
        ...
        if (pAccion === 'pendiente') {
            ...
            $scope.scpMensajeAlertaConf = '¿Está completamente seguro que desea cancelar la solicitud, a pesar de las consecuencias?';
        }
